class ParksRecIpsum {
    ...
    private let tom_s2e4 = ["Well, if you're squeaky clean like I am, there's no problem.", "Yeah, but I've never sealed the deal, just window shopping.", "You can fly to Brazil, just don't enter the cave, am I right?", "Hey Donna, let me ask you something: do you hate black people?", "'Cause apparently, in 1998, you donated money to the presidential campaign for... David Duke!"]
